import RootFinders.Bisection;
import RootFinders.IRootFinder;
import RootFinders.Newton;
import RootFinders.RootFinderType;
...
public class Controller {
    ...
    public IRootFinder getSelectedRootFinder(){
        ...
        switch (type){
            ...
            case NEWTON:
                return new Newton(); // TODO: CHANEGE WHEN IMPLEMENTED!!
            case ETC:
                return new Bisection(); // TODO: CHANEGE WHEN IMPLEMENTED!!
            default:
                return new Bisection();
        }
    }
